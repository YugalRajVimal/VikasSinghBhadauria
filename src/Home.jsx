      ...
      <div style={{ width: "100%", position: "relative", zIndex: 10 }}>
        <div className="vsb-container" style={{ display: "grid", gridTemplateColumns: "1fr 420px", gap: "4rem", alignItems: "center", paddingTop: "80px" }} id="heroGrid">
          ...
          <div style={{ opacity: 0, animation: "fadeLeft 1s ease 0.5s forwards", position: "relative" }}>
            <div style={{ width: "100%", aspectRatio: "3/4", borderRadius: "4px", overflow: "hidden", border: "1px solid var(--clr-border-s)", background: "var(--clr-portrait-bg)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "1rem" }}>
              <div style={{ width: "120px", height: "120px", borderRadius: "50%", background: "rgba(255,107,0,0.12)", border: "2px solid rgba(255,107,0,0.3)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <svg viewBox="0 0 24 24" style={{ width: "60px", height: "60px", opacity: 0.35, fill: "var(--clr-saffron)" }}><path d="M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 1.6-9.6 4.8v2.4h19.2v-2.4c0-3.2-6.4-4.8-9.6-4.8z"/></svg>
              </div>
              <span style={{ fontFamily: "'Rajdhani',sans-serif", fontSize: "0.78rem", letterSpacing: "0.25em", color: "var(--clr-text-faint)", textTransform: "uppercase" }}>Portrait Placeholder</span>
              <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "50%", background: "linear-gradient(transparent,rgba(10,22,40,0.5))" }} />
            </div>
            ...
            <div style={{ position: "absolute", bottom: "-16px", right: "20px", background: "var(--clr-saffron)", color: "#fff", padding: "0.6rem 1.2rem", borderRadius: "2px", fontFamily: "'Rajdhani',sans-serif", fontSize: "0.8rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" }}>New Delhi, India</div>
          </div>
        </div>
        {/* Stats */}
